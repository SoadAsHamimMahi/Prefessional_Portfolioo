  ...
  return (
    <ReactLenis root>
      <main className="bg-slate-950 dark:bg-slate-950 relative" ref={container}>
        {/* Grid Background */}
        <div className="absolute inset-0 bg-[linear-gradient(rgba(50,50,70,0.15)_1px,transparent_1px),linear-gradient(90deg,rgba(50,50,70,0.15)_1px,transparent_1px)] bg-[size:40px_40px] [mask-image:radial-gradient(ellipse_80%_80%_at_50%_50%,#000_70%,transparent_100%)] pointer-events-none z-0"></div>
        
        {/* Animated particles */}
        <Particles />

        {/* Enhanced background glow effects */}
        <div className="absolute top-20 left-20 w-96 h-96 bg-cyan-500/10 rounded-full filter blur-3xl animate-pulse z-0" />
        <div className="absolute bottom-20 right-20 w-96 h-96 bg-purple-500/10 rounded-full filter blur-3xl animate-pulse z-0" style={{ animationDelay: '1s' }} />
        
        <section className="text-white dark:text-white w-full relative z-10">
