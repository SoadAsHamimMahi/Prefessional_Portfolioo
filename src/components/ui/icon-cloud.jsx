...
export default function IconCloud({
  ...
  const renderedIcons = useMemo(() => {
    ...
    // Render icons based on iconSlugs order (preserving duplicates)
    return iconSlugs
      .filter((slug) => data.simpleIcons[slug])
      .map((slug) => renderCustomIcon(data.simpleIcons[slug], theme || "dark"));
